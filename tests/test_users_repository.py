...
def load_users_module(db_path: str):
    ...
    que dependem do engine e retorna os módulos de serviço e repositório de usuários.
    """
    os.environ["DB_PATH"] = db_path

    # Limpa metadata global e módulos para isolar o DB por teste
